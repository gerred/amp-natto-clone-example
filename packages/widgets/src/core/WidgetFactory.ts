...
export class WidgetFactory implements IWidgetFactory {
  private customTypes = new Map<string, WidgetType>();
  private customComponents = new Map<string, React.ComponentType<any>>();
  ...
  private validateConfig(config: any, schema: any): string[] {
    const errors: string[] = [];
  ...
  private validateValue(value: any, schema: any, path: string): string[] {
    const errors: string[] = [];
  ...
  importConfig(configJson: string): { type: string; config: WidgetConfig; state?: any } {
    try {
...
export function createChartWidget(config: any): Widget {
  return widgetFactory.create('chart', config);
}

export function createTableWidget(config: any): Widget {
  return widgetFactory.create('table', config);
}

export function createLogWidget(config: any): Widget {
  return widgetFactory.create('log', config);
}

export function createFormWidget(config: any): Widget {
  return widgetFactory.create('form', config);
}

// React component creation helpers
export function createChartComponent(props: any): React.ReactElement | null {
  return widgetFactory.createReactComponent('chart', props);
}

export function createTableComponent(props: any): React.ReactElement | null {
  return widgetFactory.createReactComponent('table', props);
}

export function createLogComponent(props: any): React.ReactElement | null {
  return widgetFactory.createReactComponent('log', props);
}

export function createFormComponent(props: any): React.ReactElement | null {
